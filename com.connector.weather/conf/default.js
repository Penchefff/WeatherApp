...
module.exports = {
	...
	admin: {
		...
		validEmails: ["d.d.penchev@gmail.com"],
	...
	session: {
		...
		encryptionKey: '1jexzh+CVgwY4EvSfrlovh4ZnRa/AQQEHeQu+U7e/g4=',
		signatureAlgorithm: 'sha512-drop256',
		signatureKey: 'j1e1HeqbJt6EbIOVqiS1o+6GBRn1OjTVPF0SVpg2id0rlCI4ytpHgI4WnS2d85BdRGZ13crqGr2qWx4P6jJIsA==',
		secret: '8Bi8TctLtp1e+UWiJiPqOPtVB1+9E1US', // should be a large unguessable string
	...
	cookieSecret: 'TOa2LvGdK5fJPguM2iLeGVcKZtjEoAoP',
